...
dojo.declare("surveyWidget.widgets.Survey",
	[dijit._Widget, dijit._Templated],
	{
		...
		getModel: function() {
			...
			+ '</textarea>';*/
			this.output.innerHTML = '<div>Copy and paste the following embed code in your html page to run the survey.</div><textarea style="width:400px; height:100px;">'
			+ '<iframe src="'+ viewUrl +'/generateEmbed.view?key=7744293024&secret=3B45DE19C689EDAFCA47&serviceURL=http://apsdb.apstrata.com/sandbox-apsdb/rest&schema=' + escape(dojo.toJson(surveyData)) + '" ></iframe>'
			+ '</textarea>';
			...
			+ '<iframe src="'+ viewUrl +'/generateEmbed.view?AF_deliveryChannel=listing&key=7744293024&secret=3B45DE19C689EDAFCA47&serviceURL=http://apsdb.apstrata.com/sandbox-apsdb/rest&schema=' + escape(dojo.toJson(listSurveyData)) + '" ></iframe>'
			+ '</textarea>';
			...
			+ '<iframe src="'+ viewUrl +'/generateEmbed.view?AF_deliveryChannel=aggregates&key=7744293024&secret=3B45DE19C689EDAFCA47&serviceURL=http://apsdb.apstrata.com/sandbox-apsdb/rest&schema=' + escape(dojo.toJson(surveyData)) + '" ></iframe>';
			+ '</textarea>';
