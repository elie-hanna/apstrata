...
dojo.provide("apstrata.dojo.client.apsdb.Operation");

dojo.require ("dojo.io.script");
dojo.require ("dojox.encoding.digests.MD5");
dojo.require("apstrata.dojo.client.util.Logger")

	dojo.declare("apstrata.dojo.client.apsdb.Operation",
	[apstrata.dojo.client.util.Logger],
	{
		...
		constructor: function(connection) {
			if (typeof connection != "object") new Error("apstrata.dojo.client.apsdb.Operation requires a connection object")
