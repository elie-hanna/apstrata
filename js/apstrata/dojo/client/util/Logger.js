 ...
 * *****************************************************************************
 */
dojo.provide("apstrata.dojo.client.util.Logger");

dojo.declare("apstrata.dojo.client.util._Logger",
[],
{
	DEBUG: 3,
	INFO: 4,
	...
	constructor: function() {
		...
		if (window.APSTRATA_CORE === undefined) {
		} else {
			if (window.APSTRATA_CORE.logConfig === undefined) {
			} else {
				if (window.APSTRATA_CORE.logConfig.buffer!=undefined) this.messages = window.APSTRATA_CORE.logConfig.buffer
				if (window.APSTRATA_CORE.logConfig.level!=undefined) this.logLevel = window.APSTRATA_CORE.logConfig.level
				if (window.APSTRATA_CORE.logConfig.verbose!=undefined) this.verbose = window.APSTRATA_CORE.logConfig.verbose				
			}
		}
	},
...
dojo.declare("apstrata.dojo.client.util.Logger",
[],
{
	constructor: function(className) {
	    this._LOGGER = new apstrata.dojo.client.util._Logger()
