...
[dijit._Widget, dojox.dtl._Templated], 
{
	...
	postCreate: function() {
		...
		if(self.showTermsAndCond=="true" && self.termsAndCondUrl!=""){
			dojo.place("<span class='termsLink'>By clicking Join, you agree to Touch Cloud's <a href='" + self.termsAndCondUrl + "'>terms and conditions</a></span>", self.form._fields.phone.domNode,"after");
		}
