...
public class ApstrataClientAndroid {
	...
	private ApstrataClientAndroid(String baseUrl, String key, AuthMode authMode) throws Exception{
	 ...
	 */
	public ApstrataClientAndroid(String baseUrl, String key, String user, String password, AuthMode authMode) throws Exception {
	 ...
	 * @throws Exception if unable to instantiate a MessageDigest that utilizes MD5
	 */
	public ApstrataClientAndroid(String baseUrl, String key, String secret, AuthMode authMode) throws Exception {
		this(baseUrl, key, authMode);
		this.secret = secret;
	}
