 ...
 * *****************************************************************************
 */
dojo.provide("apstrata.home.dashboard.DeveloperProfile")
 ...
 * @param {Object} attrs
 */
dojo.declare("apstrata.home.dashboard.DeveloperProfile", 
[apstrata.horizon.Panel], 
{
	templatePath: dojo.moduleUrl("apstrata.home.dashboard", "templates/DeveloperProfile.html"),
	loadingImagePath: '',
	...
	postCreate: function(){
		...
		dojo.place(this.formGenerator.domNode, this.panelWidget);	
