 ...
 * *****************************************************************************
 */
dojo.provide("apstrata.cms.Pages")
...
dojo.declare("apstrata.cms.Pages",
	...
	openEditor: function(value) {
		...
		this.openPanel(apstrata.horizon.WrapperPanel, {
			...
			attrs: {
				...
				save: function(v) {
					v["apsdb.ftsFields"] = "title,section1,section2,tags"
					v["section1.apsdb.fieldType"] = "text"
					v["section2.apsdb.fieldType"] = "text"

					delete v["apsdb!documentKey"]
					if (v.dijit) delete v.dijit
console.dir(v)
console.debug(dojo.toJson(v))					
