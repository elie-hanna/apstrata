 ...
 * *****************************************************************************
 */
dojo.provide("apstrata.cms.App")

dojo.require("apstrata.horizon.Container")
dojo.require("apstrata.cms.MainMenu")

dojo.declare("apstrata.cms.App", 
[apstrata.horizon.Container], 
{
	applicationId: "apstrataManagementConsole",
	
	startup: function() {
	   this.addMainPanel(apstrata.cms.MainMenu, {})
