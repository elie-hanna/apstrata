<?php
	...
	$config["DC"] = array (
		...
		"Subject" => "BAAS, back-end-as-a-service, backend-as-a-service, identity management, orchestration, custom workflow, database, security, facebook integration, twitter integration, open API, web services, fast development, ready-made, html5, SaaS, PaaS, cloud computing, rich client, RIA, iOS development, android development, push notification",
		"Version" => "1",
		"Publisher" => "apstrata",
		"Creator" => "apstrata",
